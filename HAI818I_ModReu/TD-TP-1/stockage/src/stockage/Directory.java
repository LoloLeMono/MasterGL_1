...
{
	// pour la coherence interne du dossier, il est fondamental que la collection
	...
	{
		v.visitDirectory(this); //page 338, le ... se donne au visitor
		
		for (ElementStockage el : elements)
		{
			el.accept(v);
		}
	}
