...
class UPPNot extends UPPUnOp {
	...
	RTLInst toRTL (ArrayList<Pair<String,PRegister>> locals, ArrayList<String> globals, PRegister reg, RTLInst succ) {
		PRegister registerE = e.getPRegister(locals);
		return new RTLXOri(reg,registerE, succ);
	}//toRTL
}//UPPNot
...
class UPPAnd extends UPPBinOp {
	...
	RTLInst toRTL (ArrayList<Pair<String,PRegister>> locals, ArrayList<String> globals, PRegister reg, RTLInst succ) {
		PRegister registreE1 = e1.getPRegister(locals);
		PRegister registreE2 = e2.getPRegister(locals);
		return new RTLAnd(registreE1,registreE2,reg,succ);
	}//toRTL
}//UPPAnd
...
class UPPOr extends UPPBinOp {
	...
	RTLInst toRTL (ArrayList<Pair<String,PRegister>> locals, ArrayList<String> globals, PRegister reg, RTLInst succ) {
		PRegister registreE1 = e1.getPRegister(locals);
		PRegister registreE2 = e2.getPRegister(locals);
		return new RTLOr(registreE1,registreE2,reg,succ);
	}//toRTL
...
class UPPLoad extends UPPExpr {
	...
	RTLInst toRTL (ArrayList<Pair<String,PRegister>> locals, ArrayList<String> globals, PRegister reg, RTLInst succ) {
		PRegister regAdr = addr.getPRegister(locals);
		return new RTLLoad(regAdr, reg,  succ);
	}//toRTL
...
class UPPCond extends UPPInst {
	...
	RTLInst toRTL (ArrayList<Pair<String,PRegister>> locals, ArrayList<String> globals, RTLInst succ) {
		...
		RTLInst ncondition = cond.toRTL(locals,globals,regCond,gtz);
...
class UPPProcCall extends UPPInst {
	...
	RTLInst toRTL (ArrayList<Pair<String,PRegister>> locals, ArrayList<String> globals, RTLInst succ) {
		ArrayList<PRegister> argsPRegister = new ArrayList<PRegister>();
		for (Pair<String,PRegister> e : locals){
			argsPRegister.add(e.right);
		}
		return new RTLProcCall(callee,argsPRegister,succ);
	}//toRTL
