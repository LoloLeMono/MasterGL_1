...
int main(int argc, char *argv[])
{
  ...
  /* Etape 8 : Nommer la socket du seveur */
  ...
  int resTCP = bind(ds, (struct sockaddr*) &adTCP, sizeof(adTCP));
  ...
  int dsC = accept(ds, (struct sockaddr*) &ad, &lgAdr);
  recv(dsC);
