...
public class Server {
	...
	public static void main(String args[]) {
		...
		try {
			...
			String unixPath = "/home/e20160005796/eclipse-workspace/HAI704I_ArchiLog/exportEclipseRenduTP/ServerRMI-CabinetVeterinaire/src/Server.policy";
			String windowsPath = "E:\\gitlab.com\\master_informatique\\210-ArchiDistribue\\TP\\ServerRMI-CabinetVeterinaire\\src\\Server.policy";
			
			System.setProperty( "java.security.policy", unixPath);
