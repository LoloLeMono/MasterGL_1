 ...
 * 
 */
@WebServiceClient(name = "HotelService", targetNamespace = "http://model.service.web.hotel/", wsdlLocation = "http://localhost:8080/Hotel1?wsdl")
    ...
    extends Service
{
    ...
    private final static QName HOTELSERVICE_QNAME = new QName("http://model.service.web.hotel/", "HotelService");
    ...
    public IHotelService getHotelPort() {
        return super.getPort(new QName("http://model.service.web.hotel/", "HotelPort"), IHotelService.class);
    }
    ...
    public IHotelService getHotelPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://model.service.web.hotel/", "HotelPort"), IHotelService.class, features);
    }
